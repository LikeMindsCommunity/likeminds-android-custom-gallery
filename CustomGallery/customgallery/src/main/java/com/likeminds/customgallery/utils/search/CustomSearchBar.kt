package com.likeminds.customgallery.utils.search
...
import com.likeminds.customgallery.databinding.LayoutSearchBarBinding
import com.likeminds.customgallery.utils.AnimationUtil
...
class CustomSearchBar @JvmOverloads constructor(
    ...
    fun closeSearch() {
        ...
        AnimationUtil.circleHideView(binding.searchToolbar, listenerAdapter)
    ...
    fun openSearch() {
        ...
        AnimationUtil.circleRevealView(binding.searchToolbar)
        elevation = 20F
        isOpen = true
